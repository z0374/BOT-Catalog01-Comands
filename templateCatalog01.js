...
import { downloadGdrive } from "../../engine/src/services/gDrive.js";
import { yesOrNo } from "../../engine/src/services/webhook.js";
        ...
        case normalize('waiting_preview_itemsmenu'):
            ...
            switch (normalize(comand[1])) {
                ...
                case normalize("Excluir"):
                    ...
                    await sendCallBackMessage(selectedProduct + " - " + nameProduct, chatId, env);
